# Generated by Django 5.1.15 on 2026-08-27 00:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('ADMINISTRADORA', 'Administradora'), ('EMPLEADA', 'Empleada')], default='EMPLEADA', max_length=20, verbose_name='rol')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='password_reset_tokens', to=settings.AUTH_USER_MODEL, verbose_name='usuario')),
            ],
            options={

...
class ServicioService:
    ...
    def crear_consentimiento(
        cliente_nombre: str,
        tipo_procedimiento: str = ConsentimientoInformado.TipoProcedimiento.COLORACION,
        cliente: Any = None,
        cliente_telefono: str = "",
        cliente_dni: str = "",
        otro_procedimiento_detalle: str = "",
        profesional: Any = None,
        acepta_terminos: bool = True,
        firma_digital: str = "",
        observaciones: str = "",
    ) -> ConsentimientoInformado:
        """Crea y almacena una ficha de consentimiento informado para un servicio químico."""
        return ConsentimientoInformado.objects.create(
            ...
            otro_procedimiento_detalle=otro_procedimiento_detalle.strip(),
            profesional=profesional,
